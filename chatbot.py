...
pairs = [
    ...
    [
        r"what is your name ?",
        ["I am a bot created by SunnyLikhith. you can call me crazy!",]
    ],
...
def chat():
    print("Hi! I am a chatbot created by Sunnylikhith for your service")
    chat = Chat(pairs, reflections)
    chat.converse()
#initiate the conversation
if __name__ == "__main__":
 chat()
print(" I tried my level best to perform well according to your actions ")